...
.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   !! if any of its lines has "to_design" or "to_quote" fields !!
   !! set in "False" while it has a specific "warehouse_id     !!
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
.. |badge3| image:: https://img.shields.io/badge/github-calyx--servicios%2Fcalyx-lightgray.png?logo=github
    :target: https://github.com/calyx-servicios/custom-talleres
...
This Module does not allow to create a sale order if any of its lines has "to_design" or "to_quote" fields set in "False" while it has a specific "warehouse_id
