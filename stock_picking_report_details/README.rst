...
This module extends the functionality of mrp and to allow you to print a new report 
with the sale Order and all this blueprints in mrp.routing from order design. 
...
Go to app menu and install.
 1.- [stock_picking_report_details] by Calyx.
...
This module is part of the `Custom-Talleres <https://gitlab.com/calyxservicios-group/odoo/custom-talleres>`_ project on Gitlab.