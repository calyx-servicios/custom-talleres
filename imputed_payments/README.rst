...
This module adds the functionality of posting payments made on an invoice within a sales order.
...
* Find module "imputed_payments"

* Press Install

* Go to Accounting > Sale/Purchase > Payments > Action Validate Payment > and see the modifications
