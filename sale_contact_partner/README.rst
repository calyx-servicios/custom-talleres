...
This module extends the functionality of the Contacs Module by making the email and zone fields required when a client is a customer and autofills the sale order with the contact info
